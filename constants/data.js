const userData = {
  ...
  about: {
    ...
    description: [
      ...
      `During my time in bootcamp I learned the following tech stack, HTML CSS, JavaScript, React, Node.js, Express, self taught Next.Js, databases PostgresSQL, Firebase and MongoDB, with acquiring some basic fundamamentals in AWS cloud deployment technology. I consider myself focus driven, eager to learn more and a well balanced team player.`,
    ],
